...
SELECT 	[dvWMCTickets].[ticket_state] AS "Case status",
	...
	[dvWMCTickets].[medical_reports_upload_date] AS "MR upload",
	[dvWMCTickets].[claims_upload_date] AS "Claim upload",
	...
	[dvWMCTickets].[provider_claim_upload] AS "Provider claim",
	[dvWMCTickets].[comprobante_transferencia_upload] AS "Comprobante de transferencia",
	...
	[dvWMCTickets].[provider_claim_upload_date] AS "PC upload",
	[dvWMCTickets].[comprobante_transferencia_upload_date] AS "CT upload",
